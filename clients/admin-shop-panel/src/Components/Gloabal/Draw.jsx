            ...
            >
                <List>
                    ...
                    <ListItemButton sx={{ display: 'flex', justifyContent: 'center' }}>
                        <Button variant='outlined' color='secondary' startIcon={<LoginIcon />} sx={{ fontWeight: 'bold' }}>
                            Log in
                        </Button>
                    </ListItemButton>
                    <ListItemButton sx={{ display: 'flex', justifyContent: 'center' }}>
                        <Button variant='contained' startIcon={<PersonAddAltIcon />} sx={{ bgcolor: 'primary.main', fontWeight: 'bold' }}>
                            Sign up
                        </Button>
                    </ListItemButton>
